...
model testbed_v2
  ...
  Modelica.Blocks.Interfaces.RealInput NorTRooSetCoo "North Zone Cooling Air Set Point. Default Value = 303.15";
  Modelica.Blocks.Interfaces.RealInput NorTRooSetHea "North Zone Heating Air Set Point. Default Value = 285.15";
  Modelica.Blocks.Interfaces.RealInput SouTRooSetCoo "South Zone Cooling Air Set Point. Default Value = 303.15";
  Modelica.Blocks.Interfaces.RealInput SouTRooSetHea "South Zone Heating Air Set Point. Default Value = 285.15";
  Modelica.Blocks.Interfaces.RealInput EasTRooSetCoo "East Zone Cooling Air Set Point. Default Value = 303.15";
  Modelica.Blocks.Interfaces.RealInput EasTRooSetHea "East Zone Heating Air Set Point. Default Value = 285.15";
  Modelica.Blocks.Interfaces.RealInput WesTRooSetCoo "West Zone Cooling Air Set Point. Default Value = 303.15";
  Modelica.Blocks.Interfaces.RealInput WesTRooSetHea "West Zone Heating Air Set Point. Default Value = 285.15";
